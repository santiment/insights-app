...
:global(body:not(.desktop)) a:focus, :global(body:not(.desktop)) a:visited, :global(body:not(.desktop)) a:active {
  outline: none;
}
:global(body:not(.desktop)) a:not(.pro) {
  border: none;
}
:global(body:not(.desktop)) .active {
  --bg: var(--green-light-1);
}
:global(body:not(.desktop)) .pro {
  padding: 3px 11px;
}
:global(body:not(.desktop)) .pro.active {
