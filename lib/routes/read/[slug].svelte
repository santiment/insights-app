...
<div class="insight">
  ...
  <InsightText {text} class="insight-text-3d5FfP mrg-xl mrg--t body-1" />
...
:global(body:not(.desktop)) .insight {
  padding: 24px 20px 0;
}
:global(body:not(.desktop)) h1 {
  margin-bottom: 20px;
}
:global(body:not(.desktop)) :global(.insight-text-3d5FfP) {
  margin-top: 40px;
}
...
:global(body:not(.desktop)) .divider {
  margin-top: 20px;
}</style>
