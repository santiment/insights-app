        ...
        if (env.BRANCH_NAME == "master") {
          withCredentials([
            ...
            docker.withRegistry("https://${awsRegistry}", "ecr:eu-central-1:ecr-credentials") {
              sh "docker build --build-arg BACKEND_URL=https://api-stage.santiment.net -t ${awsRegistry}/insights-app-stage:${env.BRANCH_NAME} -t ${awsRegistry}/insights-app-stage:${scmVars.GIT_COMMIT} ."
            ...
            docker.withRegistry("https://${awsRegistry}", "ecr:eu-central-1:ecr-credentials") {
              sh "docker build --build-arg BACKEND_URL=https://api.santiment.net -t ${awsRegistry}/insights-app-prod:${env.BRANCH_NAME} -t ${awsRegistry}/insights-app-prod:${scmVars.GIT_COMMIT} ."
